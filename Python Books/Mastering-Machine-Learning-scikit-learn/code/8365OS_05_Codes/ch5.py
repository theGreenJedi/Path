...
f = '/home/gavin/PycharmProjects/mastering-machine-learning/ch-decision_trees/img/tree.dot'
...
f = '/home/gavin/PycharmProjects/mastering-machine-learning/ch-decision_trees/img/is-grumpy.dot'
export_graphviz(clf, out_file=f, feature_names=labels, close=True)
...
f = '/home/gavin/PycharmProjects/mastering-machine-learning/ch-decision_trees/img/favorite-food-cat-food.dot'
export_graphviz(clf, out_file=f, feature_names=labels, close=True)
...
f = '/home/gavin/PycharmProjects/mastering-machine-learning/ch-decision_trees/img/favorite-food-dog-food.dot'
export_graphviz(clf, out_file=f, feature_names=labels, close=True)
...
f = '/home/gavin/PycharmProjects/mastering-machine-learning/ch-decision_trees/img/favorite-food-bacon.dot'
export_graphviz(clf, out_file=f, feature_names=labels, close=True)
...
clf = DecisionTreeClassifier(max_depth=None, max_features=None, criterion='entropy',
                             min_samples_leaf=1, min_samples_split=2)
clf.fit(X_train, y_train)
f = '/home/gavin/PycharmProjects/mastering-machine-learning/ch-decision_trees/img/level2-play-fetch.dot'
export_graphviz(clf, out_file=f, feature_names=labels, close=True)
...
clf = DecisionTreeClassifier(max_depth=None, max_features=None, criterion='entropy',
                             min_samples_leaf=1, min_samples_split=2)
clf.fit(X_train, y_train)
f = '/home/gavin/PycharmProjects/mastering-machine-learning/ch-decision_trees/img/level2-is-grumpy.dot'
export_graphviz(clf, out_file=f, feature_names=labels, close=True)
...
clf = DecisionTreeClassifier(max_depth=None, max_features=None, criterion='entropy',
                             min_samples_leaf=1, min_samples_split=2)
clf.fit(X_train, y_train)
f = '/home/gavin/PycharmProjects/mastering-machine-learning/ch-decision_trees/img/level2-favorite-food-dog-food.dot'
export_graphviz(clf, out_file=f, feature_names=labels, close=True)
...
clf = DecisionTreeClassifier(max_depth=None, max_features=None, criterion='entropy',
                             min_samples_leaf=1, min_samples_split=2)
clf.fit(X_train, y_train)
f = '/home/gavin/PycharmProjects/mastering-machine-learning/ch-decision_trees/img/level2-favorite-food-bacon.dot'
export_graphviz(clf, out_file=f, feature_names=labels, close=True)
...
clf = DecisionTreeClassifier(max_depth=None, max_features=None, criterion='entropy',
                             min_samples_leaf=1, min_samples_split=2)
clf.fit(X_train, y_train)
f = '/home/gavin/PycharmProjects/mastering-machine-learning/ch-decision_trees/img/level3-favorite-food-bacon.dot'
export_graphviz(clf, out_file=f, feature_names=labels, close=True)
...
clf = DecisionTreeClassifier(max_depth=None, max_features=None, criterion='entropy',
                             min_samples_leaf=1, min_samples_split=2)
clf.fit(X_train, y_train)
f = '/home/gavin/PycharmProjects/mastering-machine-learning/ch-decision_trees/img/level3-favorite-food-dog-food.dot'
export_graphviz(clf, out_file=f, feature_names=labels, close=True)
...
clf = DecisionTreeClassifier(max_depth=None, max_features=None, criterion='entropy',
                             min_samples_leaf=1, min_samples_split=2)
clf.fit(X_train, y_train)
f = '/home/gavin/PycharmProjects/mastering-machine-learning/ch-decision_trees/img/level3-plays-fetch.dot'
export_graphviz(clf, out_file=f, feature_names=labels, close=True)
