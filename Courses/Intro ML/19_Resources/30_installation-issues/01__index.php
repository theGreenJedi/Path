...
<link rel="EditURI" type="application/rsd+xml" href="//wiki.octave.org/wiki/api.php?action=rsd"/>
...
100.00%   10.327      1 - -total
 67.96%    7.018     15 - Template:Codeline
-->

<!-- Saved in parser cache with key octave_org:pcache:idhash:18-0!*!0!!en!*!* and timestamp 20171206203228 and revision id 10347
 -->
</div><div class="printfooter">
Retrieved from "<a dir="ltr" href="https://wiki.octave.org/wiki/index.php?title=Octave_for_Microsoft_Windows&amp;oldid=10347">https://wiki.octave.org/wiki/index.php?title=Octave_for_Microsoft_Windows&amp;oldid=10347</a>"</div>
		...
		<div class="visualClear"></div>
					...
					<ul id="f-list">
									<li id="lastmod"> This page was last modified on 11 May 2017, at 11:25.</li>
		...
		<script>(window.RLQ=window.RLQ||[]).push(function(){mw.loader.load(["mediawiki.toc","mediawiki.action.view.postEdit","site","mediawiki.user","mediawiki.hidpi","mediawiki.page.ready","mediawiki.searchSuggest"]);});</script><script>(window.RLQ=window.RLQ||[]).push(function(){mw.config.set({"wgBackendResponseTime":451});});</script></body></html>
